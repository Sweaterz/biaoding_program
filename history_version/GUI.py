...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(120, 490, 100, 40))
        ...
        self.save_button.setGeometry(QtCore.QRect(720, 35, 100, 40))
        self.save_button.setObjectName("save_button")
        self.save_button.setText("保存标定信息")

        # 手动标定显示按钮
        self.shoudong_button = QtWidgets.QPushButton(self.centralwidget)
        self.shoudong_button.setGeometry(QtCore.QRect(720, 90, 100, 40))
        ...
        self.result_show_button.setGeometry(QtCore.QRect(720, 145, 100, 40))
        ...
        self.label_3.setGeometry(QtCore.QRect(40, 460, 67, 17))
        ...
        self.filePath_editline.setGeometry(QtCore.QRect(120, 330, 800, 31))
        self.filePath_editline.setPlaceholderText("请输入原文件：")

        #输入保存路径
        self.savePath_editline = QtWidgets.QLineEdit(self.centralwidget)
        self.savePath_editline.setGeometry(QtCore.QRect(120, 390, 800, 31))
        ...
        self.brand_selection.setGeometry(QtCore.QRect(120, 450, 80, 31))
        ...
        self.biaoding_edit_word.setGeometry(QtCore.QRect(460, 3, 60, 19))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "激光品牌："))
