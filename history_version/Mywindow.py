...
class Window(GUI.Ui_MainWindow, QtWidgets.QMainWindow):
    ...
    def open_new_file(self):
        ...
        #todo
        # dir = "./data/my_data/"
        # file_url, _= QtWidgets.QFileDialog.getOpenFileNames(self, "选取文件夹", "./data/my_data/")
        ...
        # self.msg.setText("<br>".join(self.have_opened_files))
        # self.msg.resize(800, self.msg.frameSize().height() + 15)
        # self.msg.repaint()
        #
